...
import { TextField, Button, useTheme, Box, MenuItem, InputLabel, FormControl, Select } from "@mui/material";
      ...
      <div className="columns mt-5">
        <div className="column is-half">
          ...
          <TextField
            ...
            <InputLabel id="demo-simple-select-label">Jail Category</InputLabel>
            <Select
              label="Jail Category"
              variant="outlined"
              value={p_category}
